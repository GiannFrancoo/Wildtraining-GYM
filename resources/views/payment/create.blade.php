      ...
      <div class="card shadow mb-3">
        ...
        <div class="card-body">       
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group focused">
                <label class="form-control-label" for="price">{{ __('Abonado') }}<span class="small text-danger">*</span></label>       
                <!--Input precio-->
                <div class="input-group mb-3">
                  ...
                  @else
                    <input type="number" required class="form-control" id="priceInput" min="1" name="price" value="{{ $priceAmounthMonthPay }}">
                  @endif
            ...
            <!-- Month to pay -->
            <div class="col-md-3">
              <label class="form-control-label" for="amounthMonthPay">{{ __('Meses a abonar') }}<span class="small text-danger">*</span></label>
              <div class="form-group input-group focused">
                <input type="number" class="form-control text-center" min="1" name="amounthMonthPay" value="{{ $amounthMonthPay }}">
                <div class="input-group-append">
                  <button type="submit" class="btn btn-secondary" name="btnApply"><i class="fa fa-arrows-rotate"></i></button>
                </div>
              </div>
            </div>
