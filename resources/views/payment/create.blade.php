                        ...
                        <div class="col-lg-3 md-6 sm-8">
                            <div class="form-group focused">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" placeholder="2300..." required class="form-control" name="price" value="{{old('price')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 md-8 sm-9">
                                <div class="form-group focused">
                                    ...
                                    <input type="date" id="payment" required class="form-control" name="date" placeholder="payment" value="{{ old('date')}}">
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 -sm-10 mb-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select" readonly name="userSelected" value="{{old('userSelected')}}">    
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 -sm-10 mb-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="subscriptionSelected" value="{{old('subscriptionSelected')}}">                                           
